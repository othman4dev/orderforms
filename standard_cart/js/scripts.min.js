function scrollToGatewayInputError() {
  ...
  (e.closest("form") || jQuery("form").first())
...
function elementOutOfViewPort(e) {
  ...
  return (
    ...
    (t.any = t.top || t.left || t.bottom || t.right),
    t.any
  );
}
!(function (g) {
    ...
    var i = e[0],
      ...
      r =
        n == S
          ...
          : i[a];
    if (/^(ch|di|in)/.test(n) && !r) A(e, a);
    else if (/^(un|en|de)/.test(n) && r) L(e, a);
    else if (n == S) for (var o in r) (r[o] ? A : L)(e, o, !0);
    else
      (t && "toggle" != n) ||
        (t || e[R]("ifClicked"), r ? i[M] !== b && L(e, a) : A(e, a));
  }
  function A(e, t, n) {
    var i,
      a,
    ...
    !0 !== r[t] &&
      (!n &&
        ...
        ((i = e.closest("form")),
        (a = 'input[name="' + r.name + '"]'),
        (a = i.length ? i.find(a) : g(a)).each(function () {
          this !== r && g(this).data(j) && L(g(this), t);
        })),
      d
        ? ((r[t] = !0), r[Q] && L(e, Q, "force"))
        : (n || (r[t] = !0), s && r[k] && L(e, k, !1)),
      O(e, s, t, n)),
      r[w] && y(e, m, !0) && o.find("." + C).css(m, "default"),
      o[T](p || y(e, t) || ""),
      o.attr("role") && !d && o.attr("aria-" + (l ? w : Q), "true"),
      o[U](c || y(e, u) || "");
  }
  function L(e, t, n) {
    var i = e[0],
      ...
      l = y(e, d + E(i[M])),
      u = y(e, t + E(i[M]));
    !1 !== i[t] && ((!o && n && "force" != n) || (i[t] = !1), O(e, r, d, n)),
      !i[w] && y(e, m, !0) && a.find("." + C).css(m, "pointer"),
      a[U](u || y(e, t) || ""),
      a.attr("role") && !o && a.attr("aria-" + (s ? w : Q), "false"),
      a[T](l || y(e, d) || "");
  }
  function I(e, t) {
    e.data(j) &&
      (e.parent().html(e.attr("style", e.data(j).s || "")),
      t && e[R](t),
      e.off(".i").unwrap(),
      g(H + '[for="' + e[0].id + '"]')
        .add(e.closest(H))
  ...
  function y(e, t, n) {
    if (e.data(j)) return e.data(j).o[t + (n ? "" : "Class")];
  }
  function E(e) {
  ...
  g.fn[j] = function (t, n) {
    ...
    return /^(check|uncheck|toggle|indeterminate|determinate|disable|enable|update|destroy)$/i.test(
      ...
      ? ((t = t.toLowerCase()),
        ...
        r.each(function () {
          var e = g(this);
          "destroy" == t ? I(e, "ifDestroyed") : P(e, !0, t),
            g.isFunction(n) && n();
        }))
      : "object" != typeof t && t
      ? this
      : ((i = (u = g.extend(
        ...
        (c = u.hoverClass || "hover"),
        (p = u.focusClass || "focus"),
        (h = u.activeClass || "active"),
        (f = !!u.labelHover),
        (m = u.labelHoverClass || "hover"),
        (y = 0 | ("" + u.increaseArea).replace("%", "")),
        (i != v && i != b) || (a = 'input[type="' + i + '"]'),
        y < -50 && (y = -50),
        e(this),
        r.each(function () {
          var i = g(this),
            ...
            r =
              a[M] == v ? u.checkboxClass || "i" + v : u.radioClass || "i" + b,
            o = g(H + '[for="' + e + '"]').add(i.closest(H)),
            s = !!u.aria,
            d = j + "-" + Math.random().toString(36).substr(2, 6),
            l = '<div class="' + r + '" ' + (s ? 'role="' + a[M] + '" ' : "");
          s &&
            o.each(function () {
              (l += 'aria-labelledby="'),
                this.id ? (l += this.id) : ((this.id = d), (l += d)),
                (l += '"');
            }),
            (l = i
              .wrap(l + "/>")
            ...
            (r = g('<ins class="' + C + '"/>')
              .css(t)
              .appendTo(l)),
            i.data(j, { o: u, s: i.attr("style") }).css(n),
            u.inheritClass && l[T](a.className || ""),
            u.inheritID && e && l.attr("id", j + "-" + e),
            "static" == l.css("position") && l.css("position", "relative"),
            P(i, !0, S),
            o.length &&
              o.on(x + ".i mouseover.i mouseout.i " + D, function (e) {
                var t = e[M],
                  n = g(this);
                if (!a[w]) {
                  if (t == x) {
            ...
            i.on(
              x + ".i focus.i blur.i keyup.i keydown.i keypress.i",
              function (e) {
                var t = e[M],
                  e = e.keyCode;
                return (
                  t != x &&
                  ("keydown" == t && 32 == e
                    ? ((a[M] == b && a[Q]) || (a[Q] ? L : A)(i, Q), !1)
                    : void ("keyup" == t && a[M] == b
                        ? a[Q] || A(i, Q)
                        : /us|ur/.test(t) && l["blur" == t ? U : T](p)))
                );
              }
            ),
            r.on(
              x + " mousedown mouseup mouseover mouseout " + D,
              function (e) {
                var t = e[M],
                  n = /wn|up/.test(t) ? h : c;
                if (!a[w]) {
                  if (
                    (t == x
                      ? P(i, !1, !0)
                      : (/wn|er|in/.test(t) ? l[T](n) : l[U](n + " " + h),
                        o.length &&
                          f &&
                          n == c &&
                          o[/ut|nd/.test(t) ? U : T](m)),
                    !W)
                  )
                    return !1;
                  e.stopPropagation();
  ...
  (function (e) {
    "object" != typeof e.WHMCS &&
      (e.WHMCS = {
        hasModule: function (e) {
          return (
            typeof WHMCS[e] !== "undefined" &&
      ...
      .on("click", ".disable-on-click", function () {
        ...
        jQuery(this).addClass("disabled"),
          jQuery(this).hasClass("spinner-on-click") &&
            ((e = $(this).find("i.fas,i.far,i.fal,i.fab")),
  ...
  WHMCS.hasModule("authn") ||
    WHMCS.loadModule("authn", {
      provider: function () {
        var t = !1;
        return (
          ...
          (this.displayError = function (e, t, n) {
            ...
            t && (t = this.feedbackMessage(t)) && (e = t),
              n &&
                0 < $(".btn-logged-in-admin").length &&
                (e += " Error: " + n),
              this.feedbackContainer()
          ...
          (this.displaySuccess = function (e, t, n) {
            ...
            switch (e.result) {
              case "logged_in":
              case "2fa_needed":
                (c = this.feedbackMessage("2fa_needed")),
                  this.feedbackContainer()
              ...
              case "linking_complete":
                ...
                (p = (p =
                  ...
                  e.remote_account.firstname +
                    " " +
                    e.remote_account.lastname).trim()),
                  (c = this.feedbackMessage("linking_complete")
                    .trim()
                    .replace(":displayName", u)),
                  p && (c = c.replace(/\.$/, " (" + p + ").")),
                  this.feedbackContainer()
                ...
                s === d
                  ? ((c = this.feedbackMessage(
                    ...
                    this.feedbackContainer()
                      ...
                      .html(o + c))
                  : ((p = jQuery("input[name=email]")),
                    (i = jQuery("input[name=firstname]")),
                    (a = jQuery("input[name=lastname]")),
                    "" === p.val() && p.val(e.remote_account.email),
                    "" === i.val() && i.val(e.remote_account.firstname),
                    "" === a.val() && a.val(e.remote_account.lastname),
                    s === l
                      ...
                      : ("object" == typeof WHMCS.client.registration &&
                          WHMCS.client.registration.prefillPassword(),
                        (r = this).feedbackContainer().each(function (e, t) {
                          var n = $(t),
                            i = n
                          ...
                          n.fadeOut("slow", function () {
                            (c =
                              "checkout-new" === i
                                ? r.feedbackMessage("checkout-new")
                                : r.feedbackMessage(
                                    "login_to_link-signin-required"
                                  )),
                              n
              ...
              case "other_user_exists":
                (c = this.feedbackMessage("other_user_exists")),
                  this.feedbackContainer()
                    .removeClass("alert-info alert-success")
                    .addClass("alert alert-danger")
                    .html(o + c)
                ...
                break;
              case "already_linked":
                (c = this.feedbackMessage("already_linked")),
                  this.feedbackContainer()
                    .removeClass("alert-info alert-success")
                    .addClass("alert alert-danger")
                    .html(o + c)
                ...
                break;
              default:
                (c = this.feedbackMessage("default")),
                  this.feedbackContainer()
                    .removeClass("alert-info alert-success")
                    .addClass("alert alert-danger")
                    .html(o + c)
          ...
          (this.signIn = function (e, t, n, i, a) {
            jQuery
              ...
              .done(function (e) {
                i(),
                  WHMCS.authn.provider.displaySuccess(e, t, n),
                  jQuery("#tableLinkedAccounts").length &&
                    WHMCS.ui.dataTable
  ...
  (function (e) {
    ...
    registration: function () {
      return (
        (this.prefillPassword = function (i) {
          function e() {
            for (
              var e = WHMCS.utils.simpleRNG(),
                t = 0,
                n = i.form.password.length;
              t < n;
              t++
            )
          ...
          var t;
          void 0 === (i = i || {}).hideContainer
            ? ((t = jQuery("#inputSecurityQId").attr("id")
                ? "#containerPassword"
                : "#containerNewUserSecurity"),
              (i.hideContainer = jQuery(t)),
              (i.hideInputs = !0))
            : "string" == typeof i.hideContainer &&
              i.hideContainer.length &&
              (i.hideContainer = jQuery(i.hideContainer)),
            void 0 === i.form &&
              (i.form = {
                password: [
        ...
        (this.jsonGet = function (n) {
          (n = n || {}),
            this.get(
              ...
              function (e) {
                e.warning
                  ? (console.log("[WHMCS] Warning: " + e.warning),
                    "function" == typeof n.warning && n.warning(e.warning))
                  : e.error
                  ? (console.log("[WHMCS] Error: " + e.error),
                    "function" == typeof n.error && n.error(e.error))
                  : "function" == typeof n.success && n.success(e);
              },
              "json"
            )
              .error(function (e, t) {
                console.log("[WHMCS] Error: " + t),
        ...
        (this.jsonPost = function (n) {
          (n = n || {}),
            this.post(
              ...
              .fail(function (e, t) {
                console.log("[WHMCS] Fail: " + t),
                  "function" == typeof n.fail && n.fail(t, e);
              })
              .always(function () {
                "function" == typeof n.always && n.always();
              });
      ...
      confirmation: function () {
        ...
        return (
          (this.register = function (e) {
            return (
              t.indexOf((e = void 0 === e ? "[data-toggle=confirmation]" : e)) <
                0 && t.push(e),
              jQuery(e).confirmation({ rootSelector: e }),
              t
            );
          }),
          this
      ...
      dataTable: function () {
        return (
              ...
              void 0 === a.tables[e]
                ? (void 0 === n &&
                    (n = {
                      ...
                      language: {
                        emptyTable: r.data("langEmptyTable")
                          ? r.data("langEmptyTable")
                          : "No records found",
                      },
                    }),
                  jQuery.each(r.data(), function (e, t) {
                    void 0 !== t &&
                      ("ajaxUrl" === e
                        ...
                        ? (n.pageLength = t)
                        : "langEmptyTable" === e
                        ? (void 0 === n.language && (n.language = {}),
                          (n.language.emptyTable = t))
                        : "langZeroRecords" === e
                        ? (void 0 === n.language && (n.language = {}),
                          (n.language.zeroRecords = t))
                        : (n.key = t));
                  }),
                  jQuery.each(r.find("th"), function () {
                    void 0 === n.columns && (n.columns = []),
                      n.columns.push({ data: jQuery(this).data("name") });
                  }),
                  (a.tables[e] = a.initTable(r, n)))
                : void 0 !== n &&
                  ((i = (t = a.tables[e]).init()),
                  (i = jQuery.extend(i, n)),
                  t.destroy(),
                  (a.tables[e] = a.initTable(r, i))),
              a.tables[e]
            );
          }),
          (this.initTable = function (i, e) {
            ...
            return (
              i.data("on-draw")
                ? e.on("draw.dt", function (e, t) {
                    var n = i.data("on-draw");
                    "function" == typeof window[n] && window[n](e, t);
                  })
                : i.data("on-draw-rebind-confirmation") &&
                  e.on("draw.dt", function (e) {
        ...
        return (
          (this.copy = function (e) {
            ...
            e.tooltip({ trigger: "click", placement: "bottom" }),
              WHMCS.ui.toolTip.setTip(e, "Copied!"),
              WHMCS.ui.toolTip.hideTip(e);
          }),
          this
        );
      },
          ...
          (this.init = function (t) {
            ...
            n.initFields(t),
              $(t).on("submit", function (e) {
                ...
                $(e).length &&
                  ($(e).on("show.bs.modal hidden.bs.modal", function () {
                    n.clearErrors(t);
                  }),
          ...
          return e.each(function () {
            var e = $(this),
              ...
              n =
                ...
                "up" === d.direction || "down" === d.direction
                  ? "top"
                  : "left"),
              i =
                "up" === d.direction || "left" === d.direction ? "pos" : "neg",
              a = {},
              r = {},
              o = {};
            (a[n] = ("pos" == i ? "-=" : "+=") + d.distance),
              (r[n] = ("pos" == i ? "+=" : "-=") + 2 * d.distance),
              (o[n] = ("pos" == i ? "-=" : "+=") + 2 * d.distance),
              e.animate(a, d.speed);
            for (var s = 1; s < d.times; s++)
              e.animate(r, d.speed).animate(o, d.speed);
  ...
  WHMCS.hasModule("form") ||
    WHMCS.loadModule("form", function () {
      return (
...
function getRecommendationColors(e, t) {
  ...
  return (
    i < 25 ? e.lighten(25 - i) : 75 < i && e.darken(i - 75),
    (i = e.clone().darken(t)).isLight() && (n = tinycolor("000")),
    [e.toHexString(), i.toHexString(), n.toHexString()]
  );
}
function setRecommendationColors() {
  ...
  jQuery(".product-recommendations .product-recommendation").each(function () {
    var e = jQuery(this),
      t = e.data("color");
    (0 < t.length && null != t.match(/^#[0-9A-Fa-f]{3,6}$/gi)) ||
      (t = "#9abb3a"),
      (n = getRecommendationColors(t, 15)),
      e.css("border-color", n[0]),
      jQuery(".btn-add", e).css("background-color", n[0]),
      jQuery(".expander", e).css("color", n[0]),
      jQuery(".price", e).css("color", n[1]),
      jQuery(".text", e).css({ color: n[2] }),
      jQuery(".arrow", e).css({ "background-color": n[1], color: n[2] });
  });
}
...
WHMCS.hasModule("recaptcha") ||
  WHMCS.loadModule("recaptcha", function () {
    return (
      (this.register = function () {
        ...
        e.each(function (e, t) {
          ...
          h = i.hasClass("btn-recaptcha-invisible");
        ...
        if (e.length) {
          ...
          jQuery.getScript(t, function () {
            for (var e = p.length - 1; e >= 0; e--) p[e]();
          });
        }
  ...
  WHMCS.hasModule("utils") ||
    WHMCS.loadModule("utils", function () {
      return (
        (this.simpleRNG = function () {
          ...
          for (var a = 0; a < t; a++) {
            ...
            if (Math.random() > 0.5) i += btoa(v).substr(0, 4);
            else i += v;
            if (Math.random() > 0.5)
              i += e.substr(Math.floor(Math.random() * 13), 1);
          }
          return i;
        }),
  ...
  jQuery(document).ready(function () {
    jQuery("#main-body")
      .on(
        ...
        function (e) {
          jQuery(e.target).is(".btn, .btn span, .btn .fa") ||
            (e.preventDefault(), 0 < jQuery(".fa-square", this).length) ||
      ...
      .on("click", ".order-button, .order-btn, .btn-order-now", function (e) {
        var t;
        1 == jQuery(this).data("hasRecommendations") &&
          (e.preventDefault(),
...
function validateCheckoutCreditCardInput(e) {
  ...
  checkoutForm.find(".form-group").removeClass("has-error"),
    ...
    o &&
      !r &&
      ((o = checkoutForm.find("#inputCardCVV2")),
      "new" === t &&
        ((o = checkoutForm.find("#inputCardCVV")),
        ...
        (jQuery.payment.validateCardNumber(
          ...
          ((r = s.data("message-invalid")),
          s.hasClass("unsupported") && (r = s.data("message-unsupported")),
          checkoutForm
      ...
      o.is(":visible") &&
        !jQuery.payment.validateCardCVC(o.val(), i) &&
        (o.showInputError(), (a = !1)),
      a ||
        (n
          .prop("disabled", !1)
          .removeClass("disabled")
...
function updateConfigurableOptions(e, t) {
  WHMCS.http.jqClient.post(
    ...
    function (e) {
      ...
      t.length && t.html(jQuery(e).find("#productConfigurableOptions").html()),
        n.length && n.html(jQuery(e).find("#productAddonsContainer").html()),
        jQuery("input").iCheck({
          inheritID: !0,
...
function recalctotals() {
  ...
  var t = Math.floor(1e6 * Math.random() + 1),
    e =
      ((window.lastSliderUpdateRequestId = t),
      WHMCS.http.jqClient.post(
        whmcsBaseUrl + "/cart.php",
...
function recalculateRenewalTotals() {
  ...
  (window.lastSliderUpdateRequestId = t),
    WHMCS.http.jqClient
      ...
      .done(function (e) {
        t === window.lastSliderUpdateRequestId &&
          jQuery("#producttotal").html(e.body);
      })
      .always(function () {
        jQuery("#orderSummaryLoader").delay(500).fadeOut("slow");
      });
  ...
  for (var e = jQuery("#domainSuggestions"), t = 1; t <= 10; t++) {
    if (!(0 < furtherSuggestions))
      return void jQuery("div.more-suggestions")
        ...
        .find("span.no-more")
        .removeClass("hidden");
    e.find("div.domain-suggestion.clone:hidden:first").slideDown(),
      (furtherSuggestions = e.find(
  ...
  return e.length && !e.val()
    ...
    : void WHMCS.http.jqClient
        ...
        .done(function (e) {
          e.error
            ? (jQuery("#inputCaptcha")
                .attr("data-original-title", e.error)
                .tooltip("show"),
              i.length &&
            ...
            : (jQuery("#captchaContainer").remove(), t.trigger("submit"));
        });
}
...
jQuery(document).ready(function () {
  ...
  var a,
    ...
    o =
      ...
      t.length && t.payment("formatCardCVC"),
      jQuery("#orderSummary"));
  function n() {
    var e, t, n, i;
    "none" === jQuery("#scrollingPanelContainer").css("float")
      ? o.stop().css("margin-top", "0")
      : ((e = o.outerHeight()),
        (t = 0),
        (n = jQuery("#scrollingPanelContainer").prev(
          "div.secondary-cart-body"
        )),
        void 0 !== a && (t = a.top),
        (i = jQuery(window).scrollTop() - t + 15),
        e < jQuery(window).height()
          ? (n.stop().animate({ marginTop: 0 }),
            r - e < i && (i = r - e),
            jQuery(window).scrollTop() > t
              ? o.stop().animate({ marginTop: i })
              : o.stop().animate({ marginTop: 0 }))
          : (o.stop().animate({ marginTop: 0 }),
            i + n.height() > o.height() ||
              (jQuery(window).scrollTop() > t
                ? n.stop().animate({ marginTop: i })
                : n.stop().animate({ marginTop: 0 }))));
  }
  o.length &&
        ...
        displayRecommendations(n, "addproductajax=1&" + i, !1).done(
          function () {
            WHMCS.http.jqClient.post(n, "ajax=1&" + i, function (e) {
              e
                ? (jQuery("#btnCompleteProductConfig").html(t),
    ...
    jQuery(".addon-products").on("click", ".panel-addon", function (e) {
      e.preventDefault();
      e = jQuery(this);
      e.hasClass("panel-addon-selected")
    ...
    0 == jQuery(".domain-selection-options input:checked").length &&
      ((e = jQuery(".domain-selection-options input:first")),
      jQuery(e).iCheck("check"),
      jQuery(e).parents(".option").addClass("option-selected")),
    jQuery(
    ...
    jQuery("#frmProductDomain").submit(function (e) {
      ...
      if (
        ...
        m.is(":visible") && (m.slideUp(), m.find("select").val("")),
        "incart" == i)
      )
        r = (a = jQuery("#" + i + "sld option:selected")).text();
      else if ("subdomain" == i)
        s = (l = jQuery("#" + i + "tld option:selected")).text();
      else {
        if (((s = (l = jQuery("#" + i + "tld")).val()), r && !s))
          return l.tooltip("show"), l.focus(), !1;
        "." != s.substr(0, 1) && (s = "." + s);
      }
      if (!r) return a.tooltip("show"), a.focus(), !1;
      a.tooltip("hide"),
        l.length && l.tooltip("hide"),
        ...
        ("register" == i
          ? jQuery(".domain-lookup-register-loader")
          : "transfer" == i
          ? jQuery(".domain-lookup-transfer-loader")
          : jQuery(".domain-lookup-other-loader")
        ).show(),
        jQuery(".domain-lookup-loader").show(),
        o.find("div:not(.actions)").hide().end().find(".clone").remove(),
        ...
        "register" != i && (n.hide(), jQuery(".suggested-domains").hide()),
        e.is(":visible") || e.fadeIn(),
        "register" == i
          ? (n.fadeIn("fast"),
            jQuery("#resultDomainOption").val(i),
            (a = WHMCS.http.jqClient.post(
                    ...
                    if (!t.isValidDomain && t.domainErrorMessage)
                      ...
                      if ("string" == typeof t) u.text(t);
                        ...
                        for (
                          ...
                          h.length &&
                            (u.text() && u.append("<br />"),
                            u.append(jQuery("<span></span>").text(h)));
                        }
                      } else u.text(t.error);
                      u.show(), (a = !0);
                    }
                          ...
                          ? t.isAvailable && "string" != typeof i
                            ? (t.domainName !== t.idnDomainName &&
                              ...
                              n
                                ...
                                .attr("data-domain", t.domainName)
                                .show(),
                              n.find("button.domain-contact-support"))
                            : (("string" != typeof i || "" == i
                                ? n.find("button.unavailable")
                                : n.find("button.domain-contact-support")
                              ).show(),
                              n.find("span.available"))
                          : n
                  ...
                  : (jQuery(".suggested-domains").show(),
                    ...
                    jQuery.each(e.result, function (e, t) {
                      var n = t.tld,
                        i = t.pricing,
                        a =
                          (o.find("div:first").clone(!0, !0).appendTo(o),
                          o.find("div.domain-suggestion").last());
                      a
                        .addClass("clone")
                        .find("span.domain")
                        .html(t.sld)
                        ...
                        t.domainName !== t.idnDomainName &&
                          ...
                          m.slideDown(),
                        "string" == typeof i
                          ? (a.find("button.btn-add-to-cart").remove(),
                            "" != i
                              ? a
                        ...
                        t.group &&
                          a
                            .find("span.promo")
                            .addClass(t.group)
                            .html(t.group.toUpperCase())
                            .show(),
                        0 <
                          (furtherSuggestions = o
              ...
              .done(function (e) {
                ...
                "object" != typeof e || 0 == e.result.length
                  ...
                  : ((i = jQuery("#primaryLookupResult")),
                    ...
                    (o = i.find(".transfer-not-eligible")),
                    (s = jQuery("#resultDomain")),
                        ...
                        t.isRegistered
                          ? (a.show(),
                            r
                              ...
                              .end()
                              .find("span.price")
                              .html(n[Object.keys(n)[0]].transfer)
                              .end()
                              .find("button")
                              .attr("data-domain", t.domainName),
                            s.val(t.domainName),
          ...
          : ("owndomain" != i && "subdomain" != i && "incart" != i) ||
            WHMCS.http.jqClient
              .post(
                WHMCS.utils.getRouteUrl("/domain/check"),
                {
    ...
    jQuery("#frmProductDomainSelections").on("submit", function (e) {
      var t = jQuery("#idnLanguageSelector"),
        n = t.find("select"),
        i = jQuery(this);
      if (t.is(":visible") && !n.val())
        return e.preventDefault(), n.showInputError(), !1;
      e.preventDefault(),
        displayRecommendations(
          i.attr("action"),
          "addproductajax=1&" + i.serialize(),
          !1
        ).done(function () {
        ...
        "new" === i
          ? t.not(":visible") &&
            ...
            n
              ...
              .removeClass("requiredAttributeRemoved")
          : (a.addClass("disabled"),
            a.hasClass("spinner-on-click") &&
              ((o = a.find("i.fas,i.far,i.fal,i.fab")),
              jQuery(o)
        ...
        WHMCS.http.jqClient.jsonPost({
          ...
          success: function (e) {
            var t,
              n,
              i,
              a = jQuery("#applyCreditContainer");
            jQuery("#totalCartPrice").text(e.total),
              a.find("p").first().text(e.availableCreditBalance),
              !e.canUseCreditOnCheckout && a.is(":visible")
                ? ((t = jQuery("#skipCreditOnCheckout")),
                  a.hide(),
                  t.prop("checked", !0))
                : e.canUseCreditOnCheckout &&
                  ((t = jQuery("#useCreditOnCheckout")),
                  (n = jQuery("#spanFullCredit")),
                  (i = jQuery("#spanUseCredit")),
                  e.full
                    ? ((hideCvcOnCheckoutForExistingCard = "1"),
                      n.show().find("span").text(e.total),
                      i.is(":visible") && i.slideUp())
                    : ((hideCvcOnCheckoutForExistingCard = "0"),
                      i.show().find("span").text(e.creditBalance),
                      n.is(":visible") && n.slideUp()),
                  t.iCheck("check"),
                  a.not(":visible")) &&
                  a.slideDown(),
              r.length &&
          ...
          always: function () {
            ...
            a.removeClass("disabled"),
              a.hasClass("spinner-on-click") &&
                ((e = a.find("i.fas,i.far,i.fal,i.fab")),
                jQuery(e).hasClass("fa-spinner")) &&
                jQuery(e)
                  .removeAttr("class")
                  .addClass(e.data("original-class"));
          },
        });
    });
  ...
  var u = jQuery("#existingCardsContainer"),
    ...
    t =
      (jQuery(document).on("ifChecked", ".existing-card", function (e) {
        s.slideUp().find("input").attr("disabled", "disabled"),
          1 !== jQuery(".payment-methods:checked").data("remote-inputs") &&
            (i.slideUp().find("input").attr("disabled", "disabled"),
      ...
      h.on("ifChecked", function (e) {
        s.slideDown().find("input").removeAttr("disabled"),
          1 !== jQuery(".payment-methods:checked").data("remote-inputs") &&
            (i.slideDown().find("input").removeAttr("disabled"),
            p.slideUp().find("input").attr("disabled", "disabled"));
      }),
      jQuery(".payment-methods").on("ifChecked", function (e) {
        var o,
          ...
          l,
          i,
          t = jQuery(document).find(".existing-card");
        t.length || p.slideUp().find("input").attr("disabled", "disabled"),
          jQuery(this).hasClass("is-credit-card")
            ? ((o = jQuery(this).data("payment-type")),
              (s = jQuery(this).val()),
              (d = jQuery(this).data("show-local")),
              (l = []),
              "RemoteCreditCard" === o
                ...
                var t = jQuery(this).data("payment-type"),
                  ...
                  n =
                    ("RemoteCreditCard" === o
                      ? (r = n === s)
                      : "CreditCard" === o && (r = !0),
                    d && "CreditCard" === t && (r = a = !0),
                    jQuery('[data-paymethod-id="' + i + '"]'));
      ...
      "function" == typeof registerFormPasswordStrengthFeedback
        ? jQuery("#inputNewPassword1").keyup(
            registerFormPasswordStrengthFeedback
          )
        : jQuery("#inputNewPassword1").keyup(function () {
            (passwordStrength = getPasswordStrength(jQuery(this).val())),
              (cssClass =
                75 <= passwordStrength
                  ? ((textLabel = langPasswordStrong), "success")
                  : 30 <= passwordStrength
                  ? ((textLabel = langPasswordModerate), "warning")
                  : ((textLabel = langPasswordWeak), "danger")),
              jQuery("#passwordStrengthTextLabel").html(
                langPasswordStrength +
                  ": " +
                  passwordStrength +
                  "% " +
                  textLabel
      ...
      jQuery("#frmDomainChecker").submit(function (e) {
        ...
        e.preventDefault(),
          (void 0 !== recaptchaValidationComplete &&
            ...
            ((e = jQuery("#frmDomainChecker")),
            (t = jQuery("#inputDomain")),
            (o = jQuery("#domainSuggestions")),
            (n = jQuery("#divDynamicRecaptcha")),
            (i = jQuery("#inputCaptcha")),
            (h = jQuery("#idnLanguageSelector")),
            jQuery(".field-error-msg").hide(),
            h.is(":visible") && (h.slideUp(), h.find("select").val("")),
            (domainLookupCallCount = 0),
            t.val()
              ? (t.tooltip("hide"),
                jQuery("#captchaContainer").length
                  ...
                  : (n.tooltip("hide"),
                    ...
                    (n = WHMCS.http.jqClient.post(
                      WHMCS.utils.getRouteUrl("/domain/check"),
                      e.serialize() + "&type=domain",
                      "json"
                    )),
                    (i = WHMCS.http.jqClient.post(
                      WHMCS.utils.getRouteUrl("/domain/check"),
                      e.serialize() + "&type=spotlight",
                      "json"
                    )),
                    (e = WHMCS.http.jqClient.post(
                      WHMCS.utils.getRouteUrl("/domain/check"),
                      e.serialize() + "&type=suggestions",
                      "json"
                    )),
                    n
                      .done(function (e) {
                        ...
                        e.result.error
                          ...
                          : jQuery.each(e.result, function (e, t) {
                              var n = t.tldNoDots,
                                i = t.pricing,
                                n = jQuery(
                                  "#spotlight" + n + " .domain-lookup-result"
                                );
                              jQuery(".domain-lookup-spotlight-loader").hide(),
                                n.find("button").removeClass("checkout").hide(),
                                (t.isValidDomain
                                  ? t.isAvailable && "string" != typeof i
                                    ? (t.domainName !== t.idnDomainName &&
                                        h.not(":visible") &&
                                    ...
                                    : ("string" == typeof i
                                        ? (("" == i
                                            ? n.find("button.unavailable")
                                            : n.find(
                                                "button.domain-contact-support"
                                              )
                                          ).show(),
                                          n.find("button.invalid").hide(),
                                          n)
                                        : n
                                            .find("button.invalid")
                                            .hide()
                    ...
                    e
                      .done(function (e) {
                        ...
                        0 == e.result.length ||
                        e.result.error
                          ? jQuery(".suggested-domains").fadeOut(
                              "fast",
                              function () {
                                jQuery(this).hide();
                              }
                              ...
                              a
                                ...
                                t.group &&
                                  (a
                                    ...
                                    .addClass(t.group)
                                    .show(),
                                  a.find("span.sales-group-" + t.group).show()),
                                0 <
                                  (furtherSuggestions = o.find(
                                    "div.domain-suggestion.clone:hidden"
                                  ).length) &&
                                  jQuery("div.more-suggestions").show();
                            }),
      ...
      jQuery(".btn-add-to-cart").on("click", function () {
        ...
        jQuery(this).hasClass("checkout")
          ? (window.location = whmcsBaseUrl + "/cart.php?a=confdomains")
          : ((t = jQuery(this).attr("data-domain")),
            (n = jQuery('button[data-domain="' + t + '"]')),
            (e = jQuery(this).attr("data-whois")),
            (i = jQuery(this).hasClass("product-domain")),
            (a = jQuery("#btnDomainContinue")),
            (r = jQuery("#resultDomain")),
            (o = jQuery("#resultDomainPricingTerm")),
            (s = (d = jQuery("#idnLanguageSelector")).find("select")),
            d.is(":visible") && !s.val()
              ? s.showInputError()
              : (n.find("span.to-add").hide(),
                n.find("span.loading").show(),
                (d =
                  0 < jQuery(this).parents(".spotlight-tlds").length ||
                  0 < jQuery(this).parents(".suggested-domains").length
                    ? 1
                    : 0),
                WHMCS.http.jqClient
                  .post(
                  ...
                  .done(function (e) {
                    n.find("span.loading").hide(),
                      "added" === e.result
                        ? (n.find("span.added").show(),
                          i || n.removeAttr("disabled").addClass("checkout"),
                          r.length &&
                            !r.val() &&
                            (r.val(t),
                            o
                              .val(e.period)
                              .attr("name", "domainsregperiod[" + t + "]"),
                            0 < a.length) &&
                            a.is(":disabled") &&
                            a.removeAttr("disabled"),
                          jQuery("#cartItemCount").html(e.cartCount))
                        : (n.find("span.available.price").hide(),
                          n.find("span.unavailable").show(),
            ...
            jQuery("#captchaContainer").length
              ...
              : (s.tooltip("hide"),
                ...
                t
                  ...
                  .show(),
                WHMCS.http.jqClient
                  .post(e.attr("action"), e.serialize(), null, "json")
                  .done(function (e) {
                    if ("object" != typeof e)
                      return (
                        t
                    ...
                    "added" == e
                      ? ((window.location =
                        ...
                        (o = !0))
                      : 1 == e.isRegistered
                      ? 1 != e.epp || r || (i.tooltip("show"), i.focus())
    ...
    d =
      (t.on("ifChecked", function () {
        ...
        e.prop("checked") &&
          (s.is(":hidden") && (d = !1),
          t && 0 !== i.length
            ? (i.iCheck("check"), o.slideUp(), d && a.slideUp())
            : !t && a.is(":visible")
            ? d && a.slideUp()
            : (d && !t) || a.is(":visible") || (o.slideDown(), a.slideDown()),
          t) &&
          "new" !== n.val() &&
          (s.is(":visible")
            ? ((hideCvcOnCheckoutForExistingCard = "1"),
              r.hide().find("input").attr("disabled", "disabled"))
            : r.show().find("input").removeAttr("disabled"));
      }),
      e.on("ifChecked", function () {
        ...
        i.is(":visible") || i.slideDown(),
          e &&
            ((hideCvcOnCheckoutForExistingCard = "0"),
            "new" !== t.val() && n.show().find("input").removeAttr("disabled"),
            jQuery("#creditCardInputFields").slideDown());
      }),
      jQuery("#applyCreditContainer"));
  d.is(":visible") &&
    1 === d.data("apply-credit") &&
    t.length &&
    (e.iCheck("check"), t.iCheck("check")),
        ...
        : (t.attr("disabled", "disabled").each(function () {
          ...
          WHMCS.http.jqClient
            .post(
              ...
              { domainId: e, period: n, token: csrfToken },
              null,
              "json"
            )
            .done(function (e) {
    ...
    jQuery("#domainRenewalFilter").on("keyup", function () {
      ...
      jQuery("#domainRenewals")
        ...
        .filter(function () {
          jQuery(this).toggle(
            -1 < jQuery(this).data("domain").toLowerCase().indexOf(e)
          );
        });
    }),
    (checkoutForm = jQuery("#frmCheckout")).length &&
      checkoutForm.on("submit", validateCheckoutCreditCardInput),
    jQuery(".payment-methods:checked").trigger("ifChecked"),
    u.is(":visible") && 0 < u.find("input.existing-card").length && i.slideUp();
});
