...
<div id="order-standard_cart">
    ...
    <div class="row">
        ...
        <div class="cart-body">
            ...
            <div class="transfer-domain-form-container">
                <div class="domain-transfer-bg">
                    <form method="post" action="{$WEB_ROOT}/cart.php" id="frmDomainTransfer">
                        <input type="hidden" name="a" value="addDomainTransfer">

                        <div class="row">
                            <div class="col-sm-8 col-sm-offset-2 offset-sm-2">
                                <div class="panel card panel-default mb-0">
                                    <div class="panel-heading card-header pb-0 d-none">
            ...
            <p class="form-text text-center small mb-0 mt-2">* {lang key='orderForm.extendExclusions'}</p>
        </div>
    </div>
</div>
